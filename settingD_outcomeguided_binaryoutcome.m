...
for experiment = 1:n_experiments
    for w = 1:3
        load(strcat('/home/ac2051/rds/hpc-work/klic-psm-code/kernels-matlab/binary-outcome/experiment', int2str(experiment), '_w', int2str(w*2), '_ncov10_chain1_psm.mat'))
        all_psms(:,:,experiment,w) = psm;
    end
    w=4;
    load(strcat('/home/ac2051/rds/hpc-work/klic-psm-code/kernels-matlab/binary-outcome/experiment', int2str(experiment), '_w', int2str(w*2), '_ncov10_chain1_psm_permuted.mat'))
    all_psms(:,:,experiment,w) = psm;
end
%% Response
...
save('results/binary-outcome/settingD_outcomeguided_weights.mat', 'all_betas');
