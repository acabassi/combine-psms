...
var_sel <- "without_var_sel" # can be either "var_sel" or "without_var_sel"
extra_cov <- 10 # can be one of 2, 5, 10

### Load results
load(paste0("results/settingB_unsupervised_10_", var_sel, ".RData"))
load(paste0("results/settingB_unsupervised_10_", var_sel, "_one.RData"))
...
ggsave(paste0("figures/ari-b-extracov", extra_cov, "_", var_sel,".jpg"),
...
ggsave(paste0("figures/weights-b-extracov", extra_cov, "_", var_sel,".jpg"),
       device = "jpeg", width = 7, height = 8,
       units = "cm")
