...
for experiment = 1:n_experiments
    for w = 1:n_values_w
        load(strcat('/home/ac2051/rds/hpc-work/klic-psm-code/kernels-matlab/binary-outcome/experiment', int2str(experiment), '_w', int2str(w*2), '_ncov', int2str(n_extra_covariates+10), '_chain1_psm_exclude_y_var_sel.mat'))
...
save(strcat('results/binary-outcome/settingB_outcomeguided_weights_', int2str(n_extra_covariates), 'extracov_var_sel.mat'), 'all_betas');
