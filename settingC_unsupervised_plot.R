...
### Load results
load("results/settingC_unsupervised.RData")
load("results/settingC_unsupervised_one.RData")
...
ggsave(paste0("figures/ari-c.jpg"),
...
ggsave(paste0("figures/weights-c.jpg"),
       device = "jpeg", width = 7, height = 8,
       units = "cm")
