...
n_extra_covariates <- 5 # Can be 2, 5, 10
...
weights <- readMat(paste0("results/settingB_outcomeguided_weights_",
                          n_extra_covariates,
...
save(ari_all, weights, file = paste0("results/settingB_outcomeguided_",
...
save(ari_all, weights,
     file = paste0("results/settingB_outcomeguided_", n_extra_covariates,
                   "_var_sel.RData"))
cat("Done")
