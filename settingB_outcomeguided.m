...
for experiment = 1:n_experiments
    for w = 1:n_values_w
        load(strcat('~/OneDrive - University of Cambridge, MRC Biostatistics Unit/PHD-PROJECTS/klic-psm-code/kernels-matlab/experiment', int2str(experiment), '_w', int2str(w*2), '_ncov', int2str(n_extra_covariates+10), '_chain1_psm_exclude_y.mat'))
...
save(strcat('results/settingB_outcomeguided_weights_', int2str(n_extra_covariates), 'extracov_without_var_sel.mat'), 'all_betas');
