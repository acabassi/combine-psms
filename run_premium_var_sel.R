...
prof_regr <-profRegr(yModel="Bernoulli",
                     ...
                     nBurn=2000,
                     data=data,
                     output=paste0("premium/binary-outcome/experiment", experiment, "_w", w*10,
...
save(prof_regr,
     file = paste0("premium/binary-outcome/experiment", experiment, "_w", w*10, "_ncov", p,
                   "_chain", chain,
                   "_output_prof_regr_exclude_y_var_sel.RData"))
...
save(psm, coph_corr, binary_outcome, 
     file = paste0("premium/binary-outcome/experiment", experiment, "_w", w*10, "_ncov", p,
                   "_chain", chain, "_psm_exclude_y_var_sel.RData"))
